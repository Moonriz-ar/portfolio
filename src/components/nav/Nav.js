...
const Nav = () => {
  return (
    <nav className="flex bg-slate-900/40 max-w-fit px-3 py-2 z-10 fixed text-slate-50 bottom-3 sm:bottom-10 left-1/2 -translate-x-1/2 rounded-lg backdrop-blur-sm space-x-4">
